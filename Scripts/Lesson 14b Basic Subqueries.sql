...
--------------------------------------------------------------------------------
   ...
   */
    ...
    -->display first name of and employee 
    ...
    SELECT street_address, city, country_id       --Which are the locations?
        ...
        --> display first name of  employees who are earning more than the avg salary of the oraganization
      ...
      -->displayt firstname of emploee who are earning more than david in his department.
      ...
      SELECT first_name, salary
        ...
        WHERE salary > ALL(SELECT salary
            ...
            -->display first name of the all employees who are earning more than min of each deparment's employees. 
            --without department id 80.
            ...
            AND department_id != 80;
                ...
                select e.first_name || ' '||e.last_name emp_name, e.salary emp_salary, e.department_id, t.dep_avg
                    from employees e
                    join (select department_id, round(avg(salary),2) dep_avg from employees group by department_id) t
                    on e.department_id=t.department_id and e.salary > t.dep_avg
                    ;
...
*/
-->find/display job_id and maximum salary of each job id whose maximum salary is more than the maximum salary of sales represenattive
