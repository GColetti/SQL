...
-- 1) Show the last name and salary of those employees who earn more than $12,000.
...
/* 4) Show the first and last name, salary, and hire date for employees with the last names
      Matos or Taylor. */
...
-- 8) Show the last name and job of all employees who do not have a manager.
...
/*  14) Show the last name, job, and salary for all employees who are either a
        sales representative or stock clerk, and whose salary is not $2500, 
